        ...
        <section className="hero">
          <div className="hero-area">
            ...
            {isSmallScreen ? (
              ...
              <Typewriter
                options={{
                  strings: ['Jack Mitchell.', 'Self Taught Coder.', 'Passionate Creator.'],
                  autoStart: true,
                  loop: true,
                  delay: 75, // Adjust the typing delay for larger screens
                }}
              />
            )}
          </div>

                <p className="heroP">Front End Developer</p>

                <SmoothLink
                        className="heroSmoothLink"
                        to="aboutMe"    
                        smooth={true}       
                        duration={500}       
                        offset={-100}        
            ...
            <div className="socials">
                <div><a href="https://twitter.com/jackm2398" target='blank' className="social">
                ...
                <div><a href="https://github.com/Mitchell2398" target='blank'  className="social">
                ...
                <div><a href="https://www.linkedin.com/in/jack-mitchell-17a1ab164/" target='blank'  className="social">
